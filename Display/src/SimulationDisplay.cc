  ...
  : TGMainFrame(a_window, 10, 10, kMainFrame | kVerticalFrame)
{
  ...
  this->Connect("CloseWindow()", "SimulationDisplay", this, "DoExit()");
  ...
  MyMenuFile->Connect("Activated(Int_t)", "SimulationDisplay", this,
  ...
  MyMenuPlot->Connect("Activated(Int_t)", "SimulationDisplay", this,
  ...
  PrevEvent->Connect("Clicked()", "SimulationDisplay", this, "PrevEvent()");
  ...
  NextEvent->Connect("Clicked()", "SimulationDisplay", this, "NextEvent()");
  ...
  ExitButton->Connect("Clicked()", "SimulationDisplay", this, "DoExit()");
  ...
  MyRunEntry->Connect("ValueSet(Long_t)", "SimulationDisplay", this, "SetRunEntry()");
  (MyRunEntry->GetNumberEntry())->Connect("ReturnPressed()", "SimulationDisplay", this,
					  "SetRunEntry()");
  ...
  MyEventEntry->Connect("ValueSet(Long_t)", "SimulationDisplay", this, "SetEventEntry()");
  (MyEventEntry->GetNumberEntry())->Connect("ReturnPressed()", "SimulationDisplay", this,
					    "SetEventEntry()");
