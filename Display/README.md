...
**Warning:** As of Sep-2024, the number of ADC bins in each readout channels is 3000. This means that, for the 3D view, there's going to be a long delay (tens of seconds) to draw the ADC-counts plot. 
...
If you can, try to install GramsSim on your laptop. You can run `simd` using ROOT files generated on a remote server; don't forget to copy any custom [options.xml](../options.xml) files you created. 
